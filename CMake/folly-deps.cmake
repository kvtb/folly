...
list(APPEND FOLLY_LINK_LIBRARIES ${LIBUNWIND_LIBRARIES} ${LIBLZMA_LIBRARIES})
...
if (Backtrace_FOUND)
  list(APPEND FOLLY_INCLUDE_DIRECTORIES ${Backtrace_INCLUDE_DIRS})
  list(APPEND FOLLY_LINK_LIBRARIES ${Backtrace_LIBRARIES})
endif()
